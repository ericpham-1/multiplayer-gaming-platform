...
public class CheckerSession extends GameSession {
    /**
    ...
    public CheckerSession(String sessionId,Player player1, Player player2) {
        super(sessionId, GameType.CHECKERS);
        this.player1 = player1;
        this.player2 = player2;// player1 goes first then player 2
    }
        @Override
        public void start(ClientHandler player1Handler, ClientHandler player2Handler) {
            ...
            sendMessageToPlayer(player1, "Checkers Game Started: " + getSessionID());
            sendMessageToPlayer(player2, "Checkers Game Started: " + getSessionID());
